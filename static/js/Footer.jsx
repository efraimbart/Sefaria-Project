      ...
      <footer id="footer" className="static sans-serif">
        <div id="footerInner">
            ...
            <Section en="Developers" he="מפתחים">
                ...
                <Link href="/developers#api" en="The original Sefaria Project API Docs" he="מסמכי API" blank={true} />
                <Link href="https://github.com/seforim-app/Sefaria-Project" en="Fork us on GitHub" he="Github" blank={true} />
                <Link href="https://github.com/seforim-app/Sefaria-Export" en="Download our Data" he="בסיס נתונים" blank={true} />
            </Section>
